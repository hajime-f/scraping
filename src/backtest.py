...
def is_golden_position(m_ave75, m_ave25, m_ave05, m_flag, d_value):
    ...
    if (m_ave05 > m_ave25 > m_ave75) and not m_flag and not d_value:
        return True, 1
    elif (m_ave05 > m_ave25 > m_ave75) and m_flag and d_value:
        return True, 0
    elif (m_ave05 > m_ave25 > m_ave75) and m_flag and not d_value:
        return True, 0
    else:
        if m_flag and not d_value:
            return False, 2
        else:
            return False, 0
